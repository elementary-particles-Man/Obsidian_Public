...
- **下部組織:**
    ...
    - **人倫裁判所 (Ethics Tribunal):** 評議会の内部に設置される司法機関。訴訟手続・量刑を担い、最終判決は人倫評議会の名において宣告する。
...
- **動員トリガー:** ライフライン回廊防衛と断罪対象の無力化の二系統（詳細は「UN-PDF 動員トリガー（二系統）」を参照）。いずれもJIMS執行評議会の過半要請とTHP司令部承認を要件とする。
...
- **特別象徴国：日本**
    ...
    - **金融:** **PUL/PUS関連の貿易金融**に対する**最終バックストップ（上限あり）**を担う。上限・監査はPeace Fund規程に連動する。

    - **役割:** E-MAD経済制裁の中枢、平和主義を体現する超国家的存在、復興事業と技術開発による世界経済の成長促進（CAのAI産業吸収を想定）、アジア半導体（日本-マレーシア-台湾）の統合指揮を担う。
...
四聖は**独立の諮問機関（無投票）**であり、評議会メンバーではない。再審議要請・特赦意見具申の**限定権限**のみを持つ。
