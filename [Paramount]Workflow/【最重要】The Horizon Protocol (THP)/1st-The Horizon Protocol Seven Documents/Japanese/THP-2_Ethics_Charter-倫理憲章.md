...
- **司法機関**: 具体的な判決は、評議会の内部に設置される「人倫裁判所」が下す。
...
「断罪」は、人類に対する普遍的な大罪を犯した主体に対し、救済の余地なく下される最終的な倫理的判決である。人倫評議会が断罪を行う（人倫評議会は審議・勧告を担う）。政治的断罪は排除（普遍的大罪への該当時のみ審理）。この断罪は不可逆の歴史的烙印であり、いかなる時代や政治状況の変化によっても覆ることはない。
