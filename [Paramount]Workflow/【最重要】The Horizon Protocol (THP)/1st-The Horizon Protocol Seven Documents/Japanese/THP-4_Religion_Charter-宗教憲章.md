...
The Horizon Protocol (THP) は、宗教を国家や政治から完全に分離し、個人の内面的な精神性の領域に属するものとして再定義する。共存の基礎は、全ての宗教と思想の上位に、反証不可能な物理的・科学的な**「現実」**を絶対的な基盤として置くことにある。宗教は、この共通の現実を土台として、それぞれの教義において希望や意味付けを語る自由を有する。

#### 条文版

互いの信仰を正しいと認め合う。だから、お互いの信仰を尊重し、認め合おう。ただし、どんな信仰も、「現実」という共通の土台の上にあることだけは、忘れてはならない。
