...
- **学術版 (Academic Version)** ワルプルギスとは、特定の単一イベントではなく、複数の構造的脆弱性が相互に作用し、連鎖的なシステム崩壊 **（カスケード・コラプス）** を引き起こす複合危機 **（ポリクライシス）** の総称である。その起点は、米国の内的要因（統治機能不全、市場構造の毀損）と、外的要因（地政学的連鎖破綻、信認を揺るがす政治的言辞）のいずれか、あるいは複数となりうる。THPは、このドル体制の非可逆的な崩壊プロセスの最終段階に対する受け皿として構想された。
    
- **説明版 (Explanatory Version)** ワルプルギスは、特定の一日に起きる大事件の名前ではありません。アメリカ国内の問題（政治の混乱や金融システムの脆さ）と、世界の不安定な動きが複雑に絡み合い、いつ、どこからでも始まりうる**「世界的な連鎖倒産」**のプロセス全体を指す言葉に変わりました。THPは、この止められない崩壊の最終局面に備えるための計画です。
