# **崩壊の解剖学：Tricolorサブプライム自動車ローンABS破綻におけるシステミック・ネクサスの特定**

## **I. エグゼクティブ・サマリー**

### **「ドイツ銀行役」に関する仮説**

本件における中心的扇動者[[[Paramount]Workflow/【最重要】The Horizon Protocol (THP)/【MAIN】 The Horizon Protocol (THP)/Reports/ワルプルギス関連/サブプライム自動車ローンDR依頼]]の役割は、単一の主体によって担われたのではなく、**JPモルガン・チェース**および**バークレイズ**を主軸とする大手投資銀行シンジケートによって果たされたと結論付ける。これらの銀行は、主要な資金供給者（ウェアハウスレンダー）であると同時に、資産担保証券（ABS）の主幹事引受人および販売代理人という二重の機能を担っていた。このデュアル・ファンクションこそが、彼らをリスク創出とグローバルな拡散の結節点（ネクサス）に位置づけ、2008年金融危機における投資銀行群と機能的に同等の存在たらしめている。ウェアハウス融資段階におけるデューデリジェンスの懈怠疑惑と、その後のABSの積極的なマーケティング活動が、今回のシステミックな破綻の核心を構成する。
...
しかし、このポジティブな物語の裏では、コンプライアンス上の問題が頻発していた。Tricolorは過去に、公正信用報告法（Fair Credit Reporting Act）違反で連邦取引委員会（FTC）と和解した経歴を持つ 。さらに、2022年のバロンズ誌による調査報道では、同社の融資慣行や販売車両の品質について深刻な疑問が呈されていた 。これらの事実は、最終的な崩壊に至る以前から、同社のコンプライアンス体制とオペレーションに構造的な脆弱性が存在していたことを示唆している。
...
JPモルガン・チェース、フィフス・サード・バンコープ、バークレイズが主要なウェアハウスレンダーとして、Tricolorのローン組成に初期資金を供給していた 。これらの銀行のエクスポージャーは大きく、かつほぼ同規模であり、各行がこのクレジットラインから約2億ドル規模の潜在的損失に直面している 。オリジン銀行、レナサント銀行、トライアンフ銀行といった地方銀行もエクスポージャーを持っていたが、その規模は比較的小さい 。

#### **デューデリジェンスの失敗**

ウェアハウス・ファシリティは、担保が最初に差し入れられる場所であり、金融サプライチェーンの最上流に位置する。ここで発生したとされる二重担保は、この初期段階におけるデューデリジェンスの根本的な失敗を意味する。広範なリスク管理部門を持つこれらの洗練された金融機関が、担保不正という古典的な手口を検知するのに十分な管理体制を導入、あるいは執行できなかった。これは、収益性の高いサブプライム自動車ローン市場での手数料収入と市場シェアの追求が、基本的なリスク管理基準の緩和を招いたのではないかという深刻な疑問を提起する。

### **B. 引受幹事：汚染された金融商品のグローバルな販売代理人**

#### **シンジケート**

JPモルガンとバークレイズを中心とする同じ銀行団が、その後のABS発行において、主幹事（リード・ストラクチャリング・エージェント）、ブックランナー、そして販売管理者として機能していた 。彼らは単なる受動的な資金提供者ではなく、グローバルな投資家に販売される金融商品の設計者そのものであった。

#### **「オリジネート・トゥ・ディストリビュート」のモラルハザード**

この二重の役割は、資産の質に関わらず、それをバランスシートから切り離す強力なインセンティブを生み出す。初期のウェアハウスローンを提供した後、銀行にとって最も迅速に資金を回収し利益を確定する道は、ローンを証券化し販売することであった。これは古典的なモラルハザードの構図であり、リスクを川下の投資家に転嫁できる能力が、徹底的なデューデリジェンスを行うインセンティブを著しく弱める。

#### **「大脱出」**

JPモルガンとバークレイズが、「重要な未公開情報」を入手した後、しかし市場全体が崩壊する前に、Tricolor関連ABSの取引を制限したという事実は、決定的な証拠である 。これは、彼らがその特権的な立場を利用して、まず自己の保身を図ったことを示唆している。この行動は、2008年金融危機において、一部の銀行が顧客にRMBSを販売する一方で、同時にその価値下落に賭けていた行為と酷似している。

### **C. 歴史的アナロジー：2008年ドイツ銀行のプレイブック**

#### **不正行為の類似性**

Tricolorの引受幹事に対する疑惑は、RMBS危機におけるドイツ銀行の記録された行動と驚くほど類似している。米国司法省によるドイツ銀行に対する調査結果では、欠陥のある住宅ローンを意図的に証券化し、引受基準の質を偽り、既知のリスクを投資家から隠蔽していたことが認定されている 。

#### **現代版の等価物**

Tricolorのケースでは、担保の「欠陥」は単なる質の悪い引受基準ではなく、二重担保という明白な不正疑惑であった。ウェアハウスレンダーとして関与していた引受幹事団は、担保の真の状態を把握する上で最も有利な立場にあった。にもかかわらず、これらの資産を組成し販売したことで、彼らは実質的に、少なくとも非常に疑わしく、最悪の場合には不正に汚染されていると知るべきであった金融商品を市場に流通させたことになる。資金供給と販売の両方に直接関与したという点で、JPモルガンとバークレイズを中心とするシンジケートは、この事件における「ドイツ銀行役」に相当すると言える。  
このシンジケート構造は、2008年のように単一の「悪役」を特定することを困難にする一方で、責任の所在を曖昧にする効果も持つ。各行は互いに責任を転嫁し、他行のデューデリジェンスに依存していたと主張する可能性がある。しかし、彼らが**集合体として果たした機能**は、リスクの集中処理と販売のハブであり、現代の金融システムにおけるリスク拡散のメカニズムを理解する上で、この集合的機能を特定することが不可欠である。

### **表1：Tricolor証券化エコシステムにおける主要関係者とその役割**

| 組織・主体 | カテゴリー | Tricolorエコシステムにおける役割 | 判明しているエクスポージャー／関与 | 主要な破綻点 |
| :---- | :---- | :---- | :---- | :---- |
| **Tricolor Holdings** | オリジネーター／サービサー | 高リスクローンを組成・管理し、証券化のためにパッケージ化。 | 10億～100億ドルの負債を抱え連邦破産法第7章を申請 。 | 担保の二重担保疑惑。オペレーション上の破綻。 |
| **JPモルガン・チェース** | ウェアハウスレンダー兼主幹事 | 初期資金を提供。ABSの組成、マーケティング、販売。 | 約2億ドルのウェアハウスエクスポージャー。複数のTAST案件で主幹事。破綻後に取引を制限 。 | 担保に関するデューデリジェンスの失敗。潜在的に汚染された証券の販売。 |
| **バークレイズ** | ウェアハウスレンダー兼主幹事 | 初期資金を提供。ABSの組成、マーケティング、販売。 | 約2億ドルのウェアハウスエクスポージャー。TAST案件の主幹事。破綻後に取引を制限 。 | 担保に関するデューデリジェンスの失敗。潜在的に汚染された証券の販売。 |
| **フィフス・サード・バンコープ** | ウェアハウスレンダー兼共同幹事 | 初期資金を提供。ABS販売の共同主幹事。 | 1億7000万～2億ドルの減損損失を開示。最初に不正を公に指摘 。 | 担保に関するデューデリジェンスの失敗。 |
| **Wilmington Trust** | トラスティ（受託者） | ABS信託における投資家の受託者。 | 全てのTricolor ABS案件で受託者。状況を監視中 。 | 投資家を代表して規約を執行、または担保を検証する義務の不履行の可能性。 |
| **KBRA / ムーディーズ / S\&P** | 格付け会社 | ABSトランシェに信用格付けを付与。 | 複数のTAST案件を格付け。現在、全格付けを引き下げ方向で見直し中 。 | オリジネーター提供の情報への過度な依存。分析における根本的な不正の検知失敗。 |
| **ブラックロック** | 株式・債券投資家 | Impact Opportunities Fundを通じて9000万ドルの株式投資。ABSも保有している可能性が高い 。 | ESGの看板の下で不正企業を支援したことによるレピュテーションリスク。ABSポートフォリオにおける損失。 |  |
| **PIMCO, Janus Henderson等** | 機関投資家 | Tricolor ABSの様々なトランシェを購入・保有。 | Tricolor ABSの保有者として特定されている 。 | 拡散されたリスクの最終的な「ババ」保有者。 |

## **IV. コンテイジョンのマッピング：エクスポージャーとシステミックな影響**
...
このシナリオの真の危険性は、Tricolorの直接的な損失額そのものではない。それは、**プロセスの伝染**である。規制下にある主要な米国金融機関において、担保検証という基本的なプロセスが崩壊したという発見は、投資家や規制当局に「もしここで起きたのなら、他では起きていないのか？」という当然の疑問を抱かせる。この疑問が、他のノンバンク貸し手や他の種類のABSへと波及した場合、信用収縮は避けられない。それは、サブプライム自動車ローン市場に留まらない、より広範なクレジット市場の凍結を引き起こす可能性がある。
